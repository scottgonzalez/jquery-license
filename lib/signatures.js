...
function SignatureManager( options ) {
	this.options = options;
	this.running = false;
	this.start();
}

SignatureManager.prototype.start = function() {
...
SignatureManager.prototype.update = function() {
...
SignatureManager.prototype.stop = function() {
	this.running = false;
	clearTimeout( this.timeout );
}

SignatureManager.prototype.get = function() {
	return this.promise;
}
...
module.exports = {
	...
	init: function( options ) {
		return new SignatureManager( options );
	}
};
